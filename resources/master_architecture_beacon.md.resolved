...
│   │ checks.py)  │  │               │  │ [deep/max]         │    │
│   │ 77KB rules  │  │Pattern match  │  │ Playwright renders │    │
│   └─────────────┘  └───────────────┘  └────────────────────┘    │
│          │                                     │                  │
│          │              ┌──────────────────────┘                  │
│          ▼              ▼                                         │
...
> *"Confirmed by 3+ engines (axe-core, static, heuristic) with strong code evidence."*
...
> *"Screen reader users may miss the meaning of this meaningful image, or have to listen to the filename."*
