...
def select_links_for_enqueue(
    ...
    *,
    ...
    for raw in raw_links:
        ...
        skip_reason = _skip_reason(absolute_fetch_url, seed_host=seed_host, depth=next_depth)
        ...
        if next_depth >= 2 and page_type == "standard":
...
def _skip_reason(url: str, *, seed_host: str, depth: int) -> str | None:
